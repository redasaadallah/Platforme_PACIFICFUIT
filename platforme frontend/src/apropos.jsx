    ...
    <div id="apropos2">
        ...
        <div>
            <motion.div
                        ...
                        viewport={{ once: true, amount: 0 }}
            className="title"><div><img src={polices}/><p>Respect strict des normes de conservation</p></div><img onClick={()=>{visible===1?setvisible(0):setvisible(1)}} src={visible===1?minus:plus}/></motion.div>
            ...
            <motion.div 
                        ...
                        viewport={{ once: true, amount: 0 }}
            className="title"><div><img src={control}/><p>Température contrôlée et surveillée en continu</p></div><img onClick={()=>{visible===2?setvisible(0):setvisible(2)}} src={visible===2?minus:plus}/></motion.div>
            ...
            <motion.div 
                        ...
                        viewport={{ once: true, amount: 0 }}
            className="title"><div><img src={shield}/><p>Sécurité des installations 24h/24</p></div><img onClick={()=>{visible===3?setvisible(0):setvisible(3)}} src={visible===3?minus:plus}/></motion.div>
            ...
            <motion.div 
                        ...
                        viewport={{ once: true, amount: 0 }}
            className="title"><div><img src={support}/><p>Service client réactif et professionnel</p></div><img onClick={()=>{visible===4?setvisible(0):setvisible(4)}} src={visible===4?minus:plus}/></motion.div>
