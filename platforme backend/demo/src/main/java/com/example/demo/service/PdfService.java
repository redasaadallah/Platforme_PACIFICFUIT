...
public class PdfService {
    ...
    public byte[] generatePdf(String type,
        ...
        context.setVariable("debut", LocalDate.parse(debut).format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        context.setVariable("duree", duree);
        context.setVariable("fin", LocalDate.parse(fin).format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        context.setVariable("fait", LocalDate.parse(fait).format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
